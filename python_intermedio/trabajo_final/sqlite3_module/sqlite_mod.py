...
def insertar(con, nombre, apellido, edad, vencimiento_apto_medico, estado_apto_medico):
    cursor = con.cursor()
...
def actualizar(con, num_socio, nombre, apellido, edad, vencimiento_apto_medico, estado_apto_medico):
    cursor = con.cursor()
    num_socio = int(num_socio)
